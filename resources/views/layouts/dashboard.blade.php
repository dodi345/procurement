...
<body>
    ...
    @if (auth()->user()->hasRole('super-admin'))
        <x-dashboard.superadmin.sidebar />
    @elseif (auth()->user()->hasRole('officer'))
        <x-dashboard.officer.sidebar />
    @elseif (auth()->user()->hasRole('supplier'))
        <x-dashboard.supplier.sidebar />
    @endif
    ...
    <script src="{{ asset('vendor/NiceAdmin') }}/assets/vendor/quill/quill.js"></script>
